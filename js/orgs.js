...
const GPS_TEMPLATES = {
  owl_codelco: {
    ...
    fields: [
      { apiKey: 'proveedor_gps',       label: 'Proveedor GPS',         source: 'fixed',            fixedValue: '',  required: true  },
      { apiKey: 'rut_transportista',   label: 'RUT transportista',     source: 'fixed',            fixedValue: '',  required: true  },
      { apiKey: 'transportista',       label: 'Transportista',         source: 'fixed',            fixedValue: '',  required: true  },
      { apiKey: 'nemo',                label: 'Nemo (nombre corto)',   source: 'fixed',            fixedValue: '',  required: true  },
      { apiKey: 'vehiculo',            label: 'Número vehículo',       source: 'fixed',            fixedValue: '',  required: true  },
      { apiKey: 'termino_de_contrato', label: 'Término de contrato',   source: 'fixed',            fixedValue: '',  required: true  },
      { apiKey: 'proveedor',           label: 'Fecha fin transmisión', source: 'fixed',            fixedValue: '',  required: true  },
      ...
      { apiKey: 'desc_ubicacion',      label: 'Desc. ubicación',       source: 'fixed',            fixedValue: '',  required: true  },
    ],
  },
  sitrack_blueexpress: {
